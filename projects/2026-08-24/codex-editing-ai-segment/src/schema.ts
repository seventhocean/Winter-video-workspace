...
export type MotionRecipe = {
  ...
  card: string;
  style: string;
  adaptation: "talking-head-overlay" | "full-screen" | "transition";
  source: string;
  rationale: string;
  preserve: string[];
  changes?: string[];
...
export type VisualReference = VisualReferenceBase &
  (
    | {
    ...
    | {
        mode: "source-adapt" | "browser-capture";
        sourceCommit: string;
        sourceFiles: string[];
        assets?: string[];
        license: string;
